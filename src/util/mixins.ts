...
//+ © 2020 Basarat Ali * Used without autorisation from the author(s) this part
//+ of the code may be removed in future releases it will be your responsability
//+ to make sure this part of code is still usable under
//+ the interim licence CC BY 4.0 in the future... I will remove this comment
